...
Entry(root, font = 'arial 10', textvariable = Text, bg = 'gray').place(x=290, y = 60)

Label(root, font = 'arial 12 bold', text ='KEY').place(x=60, y = 90)
Entry(root, font = 'arial 10', textvariable = private_key , bg ='gray').place(x=290, y = 90)

Label(root, font = 'arial 12 bold', text ='MODE(e-encode, d-decode)').place(x=60, y = 120)
Entry(root, font = 'arial 10', textvariable = mode , bg= 'gray').place(x=290, y = 120)
Entry(root, font = 'arial 10 bold', textvariable = Result, bg ='gray').place(x=290, y = 150)
